...
This is `calendar-gateway`, a Swift Package Manager project with a Nix development shell, go-task automation, Homebrew formula packaging, and optional signed Homebrew Cask packaging.
